...
<body>  
	...
	<ul class="nav nav-pills ">
		&nbsp;&nbsp;<li class="nav-item"><a class="btn btn-sm btn-danger" role="button" href="${pageContext.request.contextPath}/admin/home">Home</a></li>&nbsp;&nbsp;
		<li class="nav-item"><a  class="btn btn-sm btn-danger" href="${pageContext.request.contextPath}/admin/product-list">View Products</a></li>
	</ul>
